...
- Changes APIs.
- Integrates AI agent libraries (e.g. JetBrains Koog - see `koog-agent-framework` skill).
...
- `koog-agent-framework` when introducing or modifying JetBrains Koog agent integrations.
...
- UI regression.
- API compatibility.
- AI Agent non-determinism / rate limiting (refer to `koog-agent-framework`).
