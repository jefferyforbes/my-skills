...
> [!IMPORTANT]
> **Difference from Firebase App Hosting:**
> This skill is specifically for Firebase Hosting (Classic), which is designed for static websites and SPAs. If you are deploying Next.js, Angular, or any app requiring server-side rendering or a backend logic framework out of the box, use **Firebase App Hosting** instead.
