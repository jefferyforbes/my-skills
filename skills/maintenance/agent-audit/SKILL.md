...
name: agent-audit
description: >-
  Agent System Audit — evaluate the health, efficiency, consistency, capability, and behavioural reliability of the entire agent operating system.
---
...
Perform a comprehensive system audit of the entire agent operating environment — including discoverable skills, routed workflows, references, instructions, tool definitions, and supporting scripts.

Its purpose is to evaluate the **health, efficiency, consistency, capability, and behavioural reliability** of the agent operating system.

It serves as the diagnostic entry point of the **Formal Maintenance Change Gate**:
```text
agent-audit (find opportunities) 
    → agent-testing (prove them) 
    → skill-maintenance (safely apply them) 
    → skill-optimization (compress context)
```
